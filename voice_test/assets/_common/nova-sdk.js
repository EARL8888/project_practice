    ...
    return function n(e, r, o) {
        function t(f, u) {
            if (!r[f]) {
                ...
                var l = r[f] = { exports: {} };
                e[f][0].call(l.exports, function(n) { var r = e[f][1][n]; return t(r ? r : n) }, l, l.exports, n, e, r, o)
            }
            return r[f].exports
        }
        ...
        2: [function(n, e, r) {
            (function(n) {
                ...
                if (o && o.getRandomValues) {
                    ...
                    r = function() { return o.getRandomValues(t), t }
                }
                if (!r) {
                    var i = new Array(16);
                    r = function() { for (var n, e = 0; e < 16; e++) 0 === (3 & e) && (n = 4294967296 * Math.random()), i[e] = n >>> ((3 & e) << 3) & 255; return i }
                }
                e.exports = r
    ...
    function WCRInteractiveDocSDK() {
        ...
        this.startSpeechEvaluation = function(type, language, data, timeout, callback) {
            ...
            if (this.sdk_type_ == SDKTYPE.ST_MESSAGEHANDLE) {
                ...
                window.WCRDocJSSDK.startSpeechEvaluation(JSON.stringify(messagebody), this.persistentCallback(function(content) {
                    callback(content);
                }));
            }
        };
        ...
        this.duringSpeechEvaluation = function(callback) {
            ...
            if (this.sdk_type_ == SDKTYPE.ST_MESSAGEHANDLE) {
                ...
                window.WCRDocJSSDK.duringSpeechEvaluation(JSON.stringify(messagebody), this.oneshotCallback(function(content) {
                    callback(content);
                }));
            }
        };
